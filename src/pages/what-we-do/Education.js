            ...
            <div>
                ...
                <div className="grid-container grid-x text-center">
                    ...
                    <div className="small-12">
                        ...
                        <h3>Utilization of donor funds</h3>
                        <p>
                            Support that comes in from donors are used to pay for 
                            tuition, educational supplies as well as daily upkeep 
                            of each child in the Foundation.
                        </p>
                    </div>
